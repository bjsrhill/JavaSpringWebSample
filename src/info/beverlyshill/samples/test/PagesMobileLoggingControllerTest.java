...
public class PagesMobileLoggingControllerTest extends TestCase {
	...
	public static Test suite() {
		return new TestSuite(PagesMobileLoggingController.class);
	}
	...
	public void testShowForm() throws Exception {
		...
		try {
			...
			pagesMobileLoggingController = new PagesMobileLoggingController();
			pagesMobileLoggingController
					.setPagesMobileManager(pagesMobileManager);
			ModelAndView modelAndView = pagesMobileLoggingController
					.handleRequest(mockHttpServletRequest, null);
			assertNotNull(modelAndView);
			assertNotNull(modelAndView.getModel());
			List pagesList = (List) modelAndView.getModel().get(
					PagesMobileLoggingController.MAP_KEY);
	...
	protected void setUp() throws Exception {
		try {
			...
			pagesMobileLoggingController.getPagesMobileManager()
					.savePages(page);
		} catch (Exception e) {
	...
	protected void tearDown() throws Exception {
		pagesMobileLoggingController.getPagesMobileManager().deletePage(pageId);
	}
